...
class AppColors {
  ...
  static Color get background => themeProvider.isDark
      ? const Color(0xFF0D1117)
      : const Color(0xFFF0F4FF);

  static Color get surface => themeProvider.isDark
      ? const Color(0xFF161B27)
      : Colors.white;

  static Color get surfaceAlt => themeProvider.isDark
      ? const Color(0xFF1E2535)
      : const Color(0xFFF8FAFF);

  static Color get textPrimary => themeProvider.isDark
      ? const Color(0xFFE8EEF8)
      : const Color(0xFF0D1B4B);

  static Color get textSecondary => themeProvider.isDark
      ? const Color(0xFF8A9BC0)
      : const Color(0xFF5A6A8A);

  static Color get textHint => themeProvider.isDark
      ? const Color(0xFF4A5A7A)
      : const Color(0xFFB0BED9);

  static Color get textMuted => themeProvider.isDark
      ? const Color(0xFF5A6A8A)
      : const Color(0xFF9AAAC4);

  static Color get shadow => themeProvider.isDark
      ? const Color(0x40000000)
      : const Color(0x141A3A8F);

  static Color get shadowDeep => themeProvider.isDark
      ? const Color(0x60000000)
      : const Color(0x281A3A8F);
